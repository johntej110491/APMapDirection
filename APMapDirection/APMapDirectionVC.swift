...
extension APMapDirectionVC: GMSAutocompleteViewControllerDelegate {
    ...
    func viewController(_ viewController: GMSAutocompleteViewController, didAutocompleteWith place: GMSPlace) {
        ...
        if locationSelected == .startLocation {
           ...
           let markerNew = createMarker(titleMarker: "Location End", iconMarker: #imageLiteral(resourceName: "mapspin"), latitude: place.coordinate.latitude, longitude: place.coordinate.longitude)
            markerEnd = markerNew
    ...
    func setStartPointByCurrentLocation() {
        ...
        markerStart.map = nil
        let markerNew = createMarker(titleMarker: "Location Start", iconMarker: #imageLiteral(resourceName: "mapspin"), latitude: locationCurrent.coordinate.latitude, longitude: locationCurrent.coordinate.longitude)
